window.addEventListener('DOMContentLoaded', () => {
    ...
    const observor = new MutationObserver(mutations => {
     ...
     myList3.innerHTML="Students Login Area";
    observor.observe(myList,{
       attributes:true
    });
    setTimeout(() =>{
             myList.setAttribute('value','4000492');
    },1000);
  ...
  setTimeout(() =>{
           myList1.setAttribute('value','se-023');     
           const button=document.querySelector("body > form > div.container > div > div.col-sm-4.bg-white.border-red > div > button");
           button.click();  
